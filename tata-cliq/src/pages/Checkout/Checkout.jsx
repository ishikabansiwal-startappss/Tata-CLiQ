...
const Checkout = React.memo(() => {
  ...
  const getFieldClass = (fieldName) => {
    return `checkout__input ${errors[fieldName] ? 'checkout__input--error' : ''}`;
  };
          ...
          <div className="checkout__form">
            {step === 1 && (
              <div className="checkout__address-form">
                ...
                <Button variant="accent" size="lg" fullWidth onClick={handleAddressSubmit}>
                  Continue to Payment
                </Button>
              </div>
            )}
            {step === 2 && (
              <div className="checkout__payment">
                ...
                <Button variant="accent" size="lg" fullWidth onClick={handlePaymentSubmit}>
                  Continue to Review
                </Button>
              </div>
            )}
